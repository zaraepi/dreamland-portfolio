<!--  <div class="container-graphic">
				<div>Hello this website child page</div>
				<h1>bla bla</h1>
</div> -->
<?php
			...
			<div class="flex-row">
				<div class="news-block add-bottom  inner-pad">
					<a href="<?php echo get_permalink();?>">
						...
						<h4 class="grey font1 h4-works">Netinsites</h4>
					...
					<a href="<?php echo get_permalink(199);?>" class="btn  btn-krome btn-krome-dark add-top-quarter">View Project</a>
					<a href="news.html" class="btn  btn-krome btn-krome-dark add-top-quarter">Share</a>
				</div>
				<div class="news-block add-bottom  inner-pad">
					<a href="<?php echo get_permalink();?>">
						<h4 class="grey font1 h4-works">Giapo</h4>
						<h3 class="main-heading  font2 black h3-works">The over-all point is that new technology will not necessarily replace old technology, but it will date it. By definition. Eventually, it will replace it</h3>
						<img alt="" title="" class="img-responsive" src="<?php echo $photo2_url;?>"/>
					</a>
					<a href="<?php echo get_permalink(200);?>" class="btn  btn-krome btn-krome-dark add-top-quarter">View Project</a>
					<a href="news.html" class="btn  btn-krome btn-krome-dark add-top-quarter">Share</a>
				</div>
			</div>
			<div class="flex-row">
				<div class="news-block add-bottom  inner-pad">
					<a href="<?php echo get_permalink();?>">
						<h4 class="grey font1 h4-works">Tourism</h4>
						<h3 class="main-heading  font2 black h3-works">The over-all point is that new technology will not necessarily replace old technology, but it will date it. By definition. Eventually, it will replace it</h3>
						<img alt="" title="" class="img-responsive" src="<?php echo $photo3_url;?>"/>
					</a>
					<a href="<?php echo get_permalink(201);?>" class="btn  btn-krome btn-krome-dark add-top-quarter">View Project</a>
					<a href="news.html" class="btn  btn-krome btn-krome-dark add-top-quarter">Share</a>
				</div>
				<div class="news-block add-bottom  inner-pad">
					<a href="<?php echo get_permalink();?>">
						<h4 class="grey font1 h4-works">Kiwikids</h4>
						<h3 class="main-heading  font2 black h3-works">The over-all point is that new technology will not necessarily replace old technology, but it will date it. By definition. Eventually, it will replace it</h3>
					...
					<a href="<?php echo get_permalink(202);?>" class="btn  btn-krome btn-krome-dark add-top-quarter">View Project</a>
					<a href="news.html" class="btn  btn-krome btn-krome-dark add-top-quarter">Share</a>
				</div>
			</div>
